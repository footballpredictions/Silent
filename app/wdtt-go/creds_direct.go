...
func isVirtualIface(name string) bool {
	...
	for _, bad := range []string{
		...
		"wireguard", "wg-turn", "nordlynx", "tun", "tap", "rmnet_data", // не LAN
		"bluetooth", "dummy", "loopback", "p2p",
	} {
...
func scoreLanIPv4(ip net.IP) int {
	...
	// Prefer classic LAN; mobile CGNAT (10.x) ниже приоритета чем 192.168
...
// vkDirectResolver — DNS только на публичные резолверы (не ISP Wi‑Fi).
