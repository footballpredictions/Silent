...
Вход: с компьютера **по кабелю LAN** (не с Wi‑Fi) откройте `http://192.168.1.1.silent.vpn` (вместо 192.168.1.1 — IP админки роутера). Свой логин и пароль, «Войти». Админка OpenWrt по IP с Wi‑Fi по-прежнему открывается. VPN — тумблером. Российские сайты мимо VPN: в «Исключениях» тумблер «Российские сервисы мимо VPN».
