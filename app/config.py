...
class Settings(BaseSettings):
    ...
    AVAILABILITY_MAX_EXTERNAL_CHECKS: int = 40
    # Все активные соты, не только первые четыре: иначе новый сервер без проб с РФ.
    AVAILABILITY_MAX_EXTERNAL_TARGETS: int = 8
